...
class Command(BaseCommand):
    ...
    def handle(self, *args: Any, **options: Any) -> None:
        ...
        """
        questions = [
            {'question': '¿A qué universidad voy después del segundo cuatrimestre de segundo?', 
            'answer': 'Una vez terminado el segundo cuatrimestre de segundo, cada alumno continuará sus estudios en la universidad en la que fue aceptado. Sin embargo, existe la posibilidad de solicitar un traslado de universidad.'},
